...
3. Quiet mode: if the inbox found no owner actions, no PR was opened or merged, and the plan/CI
   state is identical to the previous cycle's block, skip steps 4 and 5 (memory still records
   the cycle).
