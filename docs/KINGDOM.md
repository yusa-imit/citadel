...
| [synod](https://github.com/yusa-imit/synod) | Foundation | Pure-state-machine Raft, joint consensus, SWIM, φ-accrual, HLC, deterministic simulator | v0.2.0 (PR #15) — plan 001 (0.16 migration + Tiger Style hygiene) complete; Phase 1 Raft types/log not started |
